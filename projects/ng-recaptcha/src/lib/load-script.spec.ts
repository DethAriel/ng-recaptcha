...
describe("script loader", () => {
  ...
  afterEach(() => {
    ...
    // @ts-expect-error `grecaptcha` is expected to be optional for this to satisfy Typescript, but @types/grecaptcha specified it as required (which is arguably incorrect)
